...
public class InputController : MonoBehaviour
{
    ...
    //                    harpoonScript.force += Mathf.Lerp(0f, harpoonScript.maxForce, chargeTime * Time.deltaTime);

    //                    harpoon.transform.position = Vector3.Lerp(harpoon.transform.localPosition, harpoonScript.startPosition - harpoon.transform.right / 2.5f, chargeTime * Time.deltaTime); 
    //                }
    //            }
